  ...
  async function main() {
    ...
    document.addEventListener("recipe-selected", (event) => {
      ...
      if (recipe == void 0 || machine == void 0) {
        ...
        let selectedRecipeMachine = document.querySelector("#selected-recipe-machine>div.machine>img.icon");
